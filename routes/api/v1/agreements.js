...
router.post('/', (req, res) => {
   ...
   if (String(body.version) !== '') agreement_obj.version = body.version // Number, required
   ...
   if (String(body.is_active) !== '') agreement_obj.is_active = body.is_active // Boolean, default true
